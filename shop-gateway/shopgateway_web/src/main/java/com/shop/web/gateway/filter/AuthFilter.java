package com.shop.web.gateway.filter;

import com.shop.web.gateway.service.AuthService;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    private static final String LOGIN_URL="http://localhost:9200/api/oauth/toLogin";
